...
- [ ] 2. Implement LLMConfig schema (TDD)
  - [ ] 2.1 Write tests for LLMConfig validation
  ...
  - [ ] 2.2 Write tests for GameConfig with llm field
    - Test GameConfig accepts llm field
    - Test GameConfig uses default LLMConfig when not specified
    - _Requirements: 1.1_

  - [ ] 2.3 Implement LLMConfig class
    - Add LLMConfig to config_schema.py
    - Add llm field to GameConfig
    - Run tests to verify they pass
    - _Requirements: 1.1, 1.2, 1.3, 1.4, 1.5, 1.6, 1.7_

- [ ] 3. Checkpoint - Verify config schema
  - Run config tests
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Update OpenAIClient with retry (TDD)
  - [ ] 4.1 Write tests for OpenAIClient max_retries parameter
...
- [ ] 5. Update GeminiClient with retry (TDD)
  ...
  - [ ] 5.3 Implement GeminiClient retry logic
...
- [ ] 8. Update config.yaml with llm section
  - [ ] 8.1 Add llm section to config.yaml
    - Add example llm section with default values
    - Add comments explaining each parameter
    - _Requirements: 1.1_

- [ ] 9. Final checkpoint - All retry tests
