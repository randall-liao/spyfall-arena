...
@pytest.fixture
@patch("game.orchestrator.SpyGuessManager")
@patch("game.orchestrator.VotingManager")
@patch("game.orchestrator.TurnManager")
@patch("game.orchestrator.RoleAssigner")
@patch("game.orchestrator.ScoringEngine")
@patch("game.orchestrator.PromptBuilder")
@patch("game.orchestrator.LLMClientFactory")
def orchestrator(
    MockLLMFactory,
    MockPromptBuilder,
    MockScoringEngine,
